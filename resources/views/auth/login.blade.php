<x-layout>
    ...
    <div class="py-20 flex flex-wrap justify-center gap-16">
        <div class="rounded bg-sky-50 dark:bg-blue-900 border border-transparent hover:border-henge">
        ...
        <div class="rounded  bg-white dark:bg-blue-900 border hover:border-henge">
            <div class="p-4 mx-4 my-2">
                <div class="text-3xl">Adults</div>
                <div class="my-2 text-xl">Use your school Microsoft account</div>
                <button class="py-2 px-6 text-white bg-blue-500 dark:bg-blue-500">Log in with Microsoft</button>
            </div>
        </div>
